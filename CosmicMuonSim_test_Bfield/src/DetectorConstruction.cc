...
//
// 1 T — UNPHYSICAL, deliberately large for electron spiral test.
// At 1 T, Larmor radii for 0.5–3 MeV electrons are 2.5–12 mm,
// which fit inside the 45 mm air gap between Al plate and Scint 2.
// Change back to 0.040*tesla for the real muon experiment.
//
static constexpr G4double kFieldStrength = 1.0 * tesla;   // 1 T (test only!)
